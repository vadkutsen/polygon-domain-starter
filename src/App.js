...
const tld = ".moon";
const CONTRACT_ADDRESS = "0xaB812399c4dedAaDb57Cb2004EB6A2ff6BB50adF";
...
const App = () => {
  ...
  const renderNotConnectedContainer = () => (
    <div className="connect-wallet-container">
      <img
        src="https://media.giphy.com/media/JidwhuCLt3u5sXimzc/giphy.gif"
        alt="Moon gif"
      />
      <button
          ...
          <header>
            <div className="left">
              ...
              <p className="subtitle">
                Your immortal API you can take even to the moon!
              </p>
            </div>
